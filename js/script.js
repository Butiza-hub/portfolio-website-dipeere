...
const showProject = (projectId) => {
    ...
    if (projectId === "inspiration26") {
        ...
        <div class="project-images">
            <img src="/portfolio-website-dipeere/images/inspiration.png" class="project-screenshot">
        </div>`;
    }
    ...
    if (projectId === "ssa") {
        ...
        <div class="project-images">
            <img src="/portfolio-website-dipeere/images/ssa/ssa1.png" class="project-screenshot">
            <img src="/portfolio-website-dipeere/images/ssa/ssa2.png" class="project-screenshot">
            <img src="/portfolio-website-dipeere/images/ssa/ssa3.png" class="project-screenshot">
        </div>`;
    }
